...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "MyApp.Application": [],
  "MyApp.controller.About": [],
  "MyApp.controller.BaseSession": [],
  "MyApp.controller.Changepassword": [],
  "MyApp.controller.Forgotpassword": [],
  "MyApp.controller.Home": [],
  "MyApp.controller.Login": [],
  "MyApp.controller.Logout": [],
  "MyApp.controller.Main": [],
  "MyApp.controller.Myplan": [],
  "MyApp.controller.Myprofile": [],
  "MyApp.controller.Session": [],
  "MyApp.controller.Signup": [],
  "MyApp.controller.Txnhistory": [],
  "MyApp.controller.customers": [],
  "MyApp.controller.feedbacks": [],
  "MyApp.controller.plans": [],
  "MyApp.controller.sales": [],
  "MyApp.controller.support": [],
  "MyApp.model.MyPlan.Selected": [],
  "MyApp.model.MyPlan.UnSelected": [],
  "MyApp.model.PackageDropDown": [],
  "MyApp.store.MyPlan.Selected": [],
  "MyApp.store.MyPlan.UnSelected": [],
  "MyApp.store.PackageDropDown": [],
  "MyApp.store.TraxnHistory": [],
  "MyApp.util.MD5": [],
  "MyApp.util.SessionMonitor": [],
  "MyApp.util.Util": [],
  "MyApp.view.Main": [],
  "MyApp.view.Viewport": [],
  "MyApp.view.about.Index": [],
  "MyApp.view.changepassword.Index": [],
  "MyApp.view.customers.Index": [],
  "MyApp.view.feedbacks.Index": [],
  "MyApp.view.forgotpassword.Index": [],
  "MyApp.view.login.Index": [],
  "MyApp.view.myplan.Index": [],
  "MyApp.view.myprofile.Index": [],
  "MyApp.view.plans.Index": [],
  "MyApp.view.sales.Index": [],
  "MyApp.view.signup.Index": [],
  "MyApp.view.support.Index": [],
  "MyApp.view.txnhistory.Index": []
});
...
Ext.setVersion("ext-theme-classic-6f8470cf-d898-42d4-9aca-fe9c608b69e2", "1.0.0");
